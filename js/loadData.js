document.addEventListener("DOMContentLoaded", function () {
    ...
    <div class="team-member row">
        ...
        <!-- NAME -->
        <div class="col-12 order-1 member-name">
            <h2>${person.name}</h2>
        </div>

        <!-- IMAGE -->
        <div class="col-12 col-lg-6 order-2 text-center member-image">
            <img src="${person.image}" class="img-fluid" alt="${person.name}">
        </div>

        <!-- BUTTON (MOBILE: right after image, DESKTOP: after description) -->
        <div class="col-12 order-3 order-lg-4 member-spec">
            <ul>
        ...
        <!-- DESCRIPTION -->
        <div id="${person.contact.email}_desc_id" style="display:none;" class="col-12 order-4 order-lg-3 team-text member-desc">
            <p>${person.description}</p>
        </div>

        <!-- AVAILABILITY -->
        <div class="col-12 col-lg-6 order-5 member-time">
        ...
        <!-- CONTACT -->
        <div class="col-12 col-lg-6 order-6 member-contact">
